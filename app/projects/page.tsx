...
function ProjectCard({ project, index }: { project: Project; index: number }) {
  ...
  return (
    <Link href={`/projects/${project.id}`} className="block h-full outline-none">
      <motion.div
        className="bg-[#1E1E1E] border-[3px] sm:border-4 border-black shadow-[4px_4px_0px_#000] sm:shadow-[8px_8px_0px_#000] flex flex-col h-full min-w-0 group cursor-pointer"
